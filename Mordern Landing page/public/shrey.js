    ...
    return (
      (() => {
        ...
        var z,
          ...
          Ct = { _start: 0, endTime: Re, totalDuration: Re },
          Et = function e(t, n, r) {
            var i,
              a,
              o,
          ...
          Ft = function (e, t, n) {
            return N && !t && N.selector
              ...
              ? _e(e)
                ...
                ? [e]
                : []
              : Rt.call((t || Y).querySelectorAll(e), 0);
          },
          It = function (e) {
            return (
          ...
          Wt = function (e) {
            if (fe() && e) {
              ...
              Pe(t, r), e.register && e.register(ir, r, Xn);
            } else e && Ut.push(e);
          },
          Zt = 255,
          Qt = {
        ...
        var bn = (function (e) {
          ...
          return (
            ...
            (n.nextLabel = function (e) {
              return void 0 === e && (e = this._time), Xt(this, Et(this, e));
            }),
            (n.previousLabel = function (e) {
              return void 0 === e && (e = this._time), Xt(this, Et(this, e), 1);
            }),
            ...
            (t.updateRoot = function (e) {
              if (
                (V._ts && ($e(V, ft(e, V)), (H = an.frame)), an.frame >= Ve)
              ) {
                Ve += $.autoSleep || 120;
                var t = V._first;
        ...
        var xn,
          ...
          Tn = function (e, t, n, r, i, a, o) {
            var s,
              ...
              v,
              p,
              f = new Xn(this._pt, e, t, 0, 1, Bn, null, i),
              m = 0,
              g = 0;
            for (
              f.b = n,
          ...
          Mn = function (e, t, n, r, i, a) {
            ...
            if (
              ...
              ((n._pt = s =
                new Xn(n._pt, i, e, 0, 1, o.render, o, 0, o.priority)),
              n !== G)
            )
              for (
          ...
          Cn = function e(t, n, r) {
            var i,
              ...
              P = t._targets,
              R = t.parent,
              O = R && "nested" === R.data ? R.vars.targets : P,
            ...
            if (
              ...
              if (
                ((f = (d = P[0] ? Xe(P[0]).harness : 0) && g[d.prop]),
                (i = at(g, Ie)),
                A &&
          ...
          return (
              ...
              if (p) {
                if (
                  ...
                  (c &&
                    ...
                    this._onUpdate &&
                      !t &&
                      (f && dt(this, e, 0, n), Ht(this, "onUpdate")),
                    this._repeat &&
                      a !== s &&
                      this.vars.onRepeat &&
                      !t &&
                  ...
                  if (
                    ...
                    t < 0 && dt(e, t, 0, !0),
                      ...
                      (t >= e._tDur || t < 0) &&
                        ...
                        n ||
                          B ||
                          (Ht(e, l ? "onComplete" : "onReverseComplete", !0),
                          e._prom && e._prom()));
            ...
            (n.kill = function (e, t) {
              if ((void 0 === t && (t = "all"), !(e || (t && "all" !== t))))
                return (
                  (this._lazy = this._pt = 0), this.parent ? Gt(this) : this
                );
              if (this.timeline) {
              ...
              if (
                ...
                return "all" === t && (this._pt = 0), Gt(this);
              for (
                r = this._op = this._op || [],
                  "all" !== t &&
                    (ue(t) &&
                ...
                if (~d.indexOf(c[u]))
                  ...
                  o))
                    (l = i && i[s]) &&
                      ...
                      delete i[s]),
                      "all" !== a && (a[s] = 1);
              return this._initted && !this._pt && v && Gt(this), this;
            }),
            (t.to = function (e, n) {
